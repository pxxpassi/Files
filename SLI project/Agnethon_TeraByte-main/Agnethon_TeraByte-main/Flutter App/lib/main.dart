...
class _CameraScreenState extends State<CameraScreen> {
  ...
  // Add a StreamController for handling images
  late StreamController<Uint8List> _imageStreamController;

  @override
  void initState() {
    super.initState();
    _imageStreamController = StreamController<Uint8List>(); // Initialize the stream controller
    getCameras();
  ...
  Future<void> sendImageToBackend(Uint8List imageBytes) async {
    final response = await http.post(
      Uri.parse('http://localhost:5000/detect_sign_language'),
      body: imageBytes,
    );
